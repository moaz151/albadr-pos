                                ...
                                <div class="col-sm-3">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" id="payment_type{{\App\Enums\PaymentTypeEnum::debit}}" type="radio" name="payment_type"
                                               value="{{\App\Enums\PaymentTypeEnum::debit->value}}"
                                               @if(old('payment_type') == \App\Enums\PaymentTypeEnum::debit->value) checked @endif>
                                        <label for="payment_type{{\App\Enums\PaymentTypeEnum::debit->value}}" class="form-check-label">{{ \App\Enums\PaymentTypeEnum::debit->label() }}</label>
                                    </div>
                                </div>
                                <div class="col-sm-3">
                                    <div class="form-group">
...
@push('js')
    <script>
        ...
        $("#add_item").on('click', function (e) {
            ...
            // Validate decimal quantities if not allowed
        ...
        // Validate quantity changes in table
